...
class Settings:
    """Application settings for the enterprise workflow engine."""
    ...
    def __init__(self):
        ...
        self.PROJECT_NAME = os.getenv("PROJECT_NAME", "Enterprise Multi-Agent Workflow Engine")
        self.VERSION = os.getenv("VERSION", "1.0.0")
        self.DESCRIPTION = os.getenv(
            "DESCRIPTION", "Enterprise-grade multi-agent workflow engine built with FastAPI and LangGraph"
        )
